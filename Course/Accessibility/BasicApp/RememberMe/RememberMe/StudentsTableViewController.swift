...
class StudentsTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            let destination = segue.destination as? StudentDetailsVC
        {
            ...
            /*
            destination.personsImageView.image = UIImage(named: student.image)
            destination.nameLabel.text = "\(student.firstname) \(student.lastname)"
            destination.courseLabel.text = "Course: \(student.course)"
            destination.cohortLabel.text = "Cohort:\(student.cohort)"
            destination.notesLabel.text = student.notes
            */
        }
    }
